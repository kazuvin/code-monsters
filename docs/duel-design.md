...
2. Configure Volt's ordered normal program and one interrupt reaction. On each cooldown, conditions are evaluated from the top and only the first matching normal action executes.
