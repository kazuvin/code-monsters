...
const ShopUnitTrait=({unit}:{unit:UnitDefinition})=>{
  ...
  return <div className={`shop-unit-trait ${instruction.action==='berserk'?'berserk':''}`}>
    ...
    <b>{reactionDetails[reaction.trigger].title} → {instruction.short}</b>
...
function makeShop(seed=0):ShopItem[]{
  ...
  if(seed===0){
    picks[0]={kind:'unit',id:'relay'};
    picks[3]={kind:'unit',id:'wrath'};
