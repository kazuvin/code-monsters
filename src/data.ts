...
export type ReactionTriggerDefinition = {id:ReactionTrigger;label:string;title:string;flavor:string;effect:string};
...
export type GameBalanceData = {
  ...
  defaultReactions: {unitId:string;trigger:ReactionTrigger|null;actionId:string|null;fixedReaction:boolean}[];
};
