...
if (!shopText.includes('RARE / JUMP') || !shopText.includes('水平速度 +14') || !shopText.includes('垂直速度 +30'))
...
if (horizontalTravel < 4 || peakHeight < 8) throw new Error('ジャンプジェットの空間移動量が不足しています');
