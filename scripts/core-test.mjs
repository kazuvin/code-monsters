...
pullTeam[0].program = [{ conditionId: 'enemyOutOfRange', actionId: 'pull-in' }];
...
farPullTeam[0].program = [
  { conditionId: 'enemyOutOfRange', actionId: 'pull-in' },
  { conditionId: 'enemyOutOfRange', actionId: 'approach' },
];
