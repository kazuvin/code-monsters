...
- For battle presentation or build-screen changes, also run the relevant browser regression scripts (`test:loadout`, `test:run`, `test:mobile`, `test:miss`, `test:jump`, `test:projectile`, `test:field`, or `test:visual`).
